...
const ResultPage = () => {
  ...
  const [showCapturingCity, setShowCapturingCity] = useState(true);
        ...
        {showCapturingCity && capturingCity && (
          <div className="card" style={{ padding: "10px" }}>
            ...
            <img
              ...
              src={capturingCity.image}
              alt={capturingCity.name}
            />
          </div>
        )}
      </div>
        ...
        <div>
          ...
          <div className="card" style={{ padding: "10px" }}>
            ...
            <img
              ...
              src={criminalData.data.cop.image}
              alt={criminalData.data.cop.name}
            />
          </div>
          <button
            className="startGame"
