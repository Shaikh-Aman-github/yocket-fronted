...
import useTypingAnimation from "../components/TypingTitle";
import { fetchCriminal } from "../Request/UserRequest";
        ...
        {showImage ? (
          ...
          <div>
            ...
            <img
              ...
              src={criminalData.image}
              alt={criminalData.name}
              srcset=""
            />
            <h5>{animatedText}</h5>
            <button
              onClick={startGame}
              className="startGame"
              title="Help to find the Criminal"
            >
              Start
            </button>
          </div>
